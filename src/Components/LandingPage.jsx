  ...
  return (
    <div className="container w-full min-h-screen mx-auto mt-5 relative px-4">
      ...
      {/* <dialog id="my_modal_1" className="modal">
        <div className="modal-box w-full max-w-[95%] sm:max-w-[600px] lg:max-w-[800px]">
          <div className="w-full flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-3 mt-6 justify-center">
              {categoryData.map((data) => (
                <button
                  ...
                  className={`border p-2 px-4 rounded font-medium cursor-pointer ${
                    categoryID === data.id
            ...
            <div className="mt-6 flex justify-center sm:justify-end gap-4">
              <form method="dialog">
                <button className="px-4 py-2 border text-gray-600 cursor-pointer">
                  Cancel
                </button>
              </form>

              <button
                className="px-4 py-2 bg-amber-400 text-white font-bold cursor-pointer"
